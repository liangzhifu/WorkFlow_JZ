...
<head>
    ...
    <%
        ...
        String taskOrderId = request.getParameter("taskOrderId");//用request得到D
        request.setAttribute("taskOrderId", taskOrderId);
    %>
</head>
<body>
<form method='post' id='excelForm' enctype='multipart/form-data' action='/WorkFlow/fileUpload/taskOrderUploadFile.do'>
